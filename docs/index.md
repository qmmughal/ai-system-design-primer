...
**[Download the book PDF](../book/The-AI-System-Design-Primer.pdf)** — 7.5×9.5 trade format, cover, contents, parts, and all chapters.
...
| Design retrieval that does not silently lie | [RAG](topics/04-rag.md) · [Retrieval](topics/05-retrieval.md) · [Silent lies](failures/01-rag-silent-lies.md) |
| Decide if I even need an agent | [Agents are loops](topics/06-agents.md) |
| Stop guessing and start measuring | [Evals](topics/09-evals.md) · [Eval gaming](failures/03-eval-gaming.md) |
| Control cost and latency | [Cost, latency, routing](topics/11-cost-latency-routing.md) |
| Not get prompt-injected | [Safety](topics/12-safety.md) · [Injection](failures/04-prompt-injection.md) |
| Practice interviews | [Interview index](interviews/README.md) |
...
1. [How to use this primer](topics/00-how-to-use.md)
2. [The systems model of an LLM](topics/01-llm-systems-model.md)
3. [The request path](topics/02-request-path.md)
4. [RAG](topics/04-rag.md)
5. [Agents are loops](topics/06-agents.md)
6. [Evals](topics/09-evals.md)
7. Interview: [Enterprise RAG](interviews/03-enterprise-rag.md)
...
**Staff / principal**
- [Memory](topics/08-memory.md), [Routing](topics/11-cost-latency-routing.md),
  [Safety](topics/12-safety.md), [Gateways](topics/13-gateways.md)
- Failures: [eval gaming](failures/03-eval-gaming.md),
  [memory poisoning](failures/08-memory-poisoning.md),
  [cost blowups](failures/06-cost-blowups.md)
- Interviews: [gateway](interviews/06-llm-gateway.md),
  [eval platform](interviews/08-eval-platform.md),
  [browsing agent](interviews/15-browsing-agent.md),
  [cost-optimized inference](interviews/14-cost-optimized-inference.md)
...
| --- | --- | --- |
| 0 | [How to use this primer](topics/00-how-to-use.md) | Run a design the way an interviewer will |
| 1 | [The systems model of an LLM](topics/01-llm-systems-model.md) | Talk about models as latency/cost/capability SLO objects |
| 2 | [The request path](topics/02-request-path.md) | Trace one call from auth to billed tokens |
| 3 | [Context is a scarce resource](topics/03-context.md) | Pack a prompt on purpose |
| 4 | [RAG](topics/04-rag.md) | Choose naive vs agentic vs graph RAG, and say when not to |
| 5 | [Chunking, embeddings, retrieval](topics/05-retrieval.md) | Design an index you can debug |
| 6 | [Agents are loops](topics/06-agents.md) | Specify halt, budget, and side effects |
| 7 | [Tools and MCP](topics/07-tools-mcp.md) | Design a tool surface that is hard to abuse |
| 8 | [Memory](topics/08-memory.md) | Split working / episodic / profile memory |
| 9 | [Evals](topics/09-evals.md) | Build an eval that predicts production |
| 10 | [Observability](topics/10-observability.md) | Trace a bad answer to a span |
| 11 | [Cost, latency, routing](topics/11-cost-latency-routing.md) | Hit a $ / request budget |
| 12 | [Safety](topics/12-safety.md) | Threat-model tools + untrusted text |
| 13 | [Gateways, caching, structured output](topics/13-gateways.md) | Build the platform layer |
...
| Failure | One-line |
| --- | --- |
| [RAG silent lies](failures/01-rag-silent-lies.md) | Retrieved the wrong chunk; answered anyway |
| [Agent loops](failures/02-agent-loops.md) | The while-loop never earned a halt |
| [Eval gaming](failures/03-eval-gaming.md) | The judge and the system share a tell |
| [Prompt injection](failures/04-prompt-injection.md) | Untrusted text issued a tool call |
| [Context rot](failures/05-context-rot.md) | The working set drowned the instruction |
| [Cost blowups](failures/06-cost-blowups.md) | Retries, tools, and output tokens stacked |
| [Tool hallucination](failures/07-tool-hallucination.md) | Invented arguments, or skipped the tool |
| [Memory poisoning](failures/08-memory-poisoning.md) | A lie got persisted and then trusted |
...
1. [Design ChatGPT](interviews/01-design-chatgpt.md)
2. [Design a customer support agent](interviews/02-customer-support-agent.md)
3. [Design enterprise RAG](interviews/03-enterprise-rag.md)
4. [Design a coding assistant](interviews/04-coding-assistant.md)
5. [Design AI search](interviews/05-ai-search.md)
6. [Design an LLM gateway](interviews/06-llm-gateway.md)
7. [Design memory for a personal assistant](interviews/07-personal-memory.md)
8. [Design an eval platform](interviews/08-eval-platform.md)
9. [Design a code review agent](interviews/09-code-review-agent.md)
10. [Design a realtime voice agent](interviews/10-voice-agent.md)
11. [Design multimodal product search](interviews/11-multimodal-search.md)
12. [Design workplace search](interviews/12-workplace-ai.md)
13. [Design LLM content moderation](interviews/13-moderation.md)
14. [Design cost-optimized inference](interviews/14-cost-optimized-inference.md)
15. [Design a browsing agent](interviews/15-browsing-agent.md)
16. [Design an AI tutor](interviews/16-ai-tutor.md)
17. [Design meeting summarization](interviews/17-meeting-summarization.md)
18. [Design a multi-agent research system](interviews/18-multi-agent-research.md)
...
Prose is [CC BY-SA 4.0](license.md). Code samples are MIT.
